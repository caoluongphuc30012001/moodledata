...
class __Mustache_e6ae5da08c212e0ffa9c6b4e55796080 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <button id="sortingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle mb-lg-0 mt-lg-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
