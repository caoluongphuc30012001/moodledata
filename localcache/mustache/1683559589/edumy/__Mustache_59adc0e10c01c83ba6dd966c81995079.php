...
class __Mustache_59adc0e10c01c83ba6dd966c81995079 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEa4276cd660f9e967b2c9185138aa60c($context, $indent, $value);
        $value = $context->find('collapseable');
        if (empty($value)) {
...
';
    ...
    private function sectionEa4276cd660f9e967b2c9185138aa60c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <legend class="d-flex align-items-center">
        <div class="position-relative d-flex ftoggler align-items-center position-relative mr-1">
            <a data-toggle="collapse"
                ...
                class=" btn-icon mr-1 icons-collapse-expand stretched-link fheader {{#collapsed}}collapsed{{/collapsed}}"
                >
...
';
                ...
                $buffer .= 'container"
';
                $buffer .= $indent . '                class=" btn-icon mr-1 icons-collapse-expand stretched-link fheader ';
                $value = $context->find('collapsed');
