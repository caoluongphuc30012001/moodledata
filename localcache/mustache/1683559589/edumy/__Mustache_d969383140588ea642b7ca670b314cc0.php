...
class __Mustache_d969383140588ea642b7ca670b314cc0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3d8e9a666e2b8e9cf0d216126eeb6eb0($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function section3d8e9a666e2b8e9cf0d216126eeb6eb0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="dropdown mr-1">
    <button id="groupingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle mb-lg-0 mt-lg-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="{{#str}} aria:groupingdropdown, block_myoverview {{/str}}">
...
';
                $buffer .= $indent . '    <button id="groupingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle mb-lg-0 mt-lg-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
                $value = $context->find('str');
